...
define([
    ...
    return declare("bgagame.newton", ebg.core.gamegui, new Newton());
});
...
var Newton = /** @class */ (function (_super) {
    ...
    Newton.prototype.setup = function (gamedatas) {
    ...
    /// -- MISC UTILITY -- ///
    //#region
    Newton.prototype.takeAction = function (action, data, confirm, confirmConfig) {
        var _this = this;
    ...
    /* @Override */
    Newton.prototype.onScreenWidthChange = function () {
    };
    /* @Override */
    Newton.prototype.updatePlayerOrdering = function () {
        this.inherited(arguments);
        console.log("Updating Player ordering");
        $('player_boards').insertAdjacentElement('afterbegin', $('preferences_panel'));
    };
    /* @Override */
    Newton.prototype.format_string_recursive = function (log, args) {
        try {
    ...
    Newton.prototype.initPreferenceObserver = function () {
        var _this = this;
    ...
    Newton.prototype.onPreferenceChange = function (prefId, prefValue) {
    ...
    Newton.prototype.updatePreference = function (prefId, newValue) {
    ...
    Newton.prototype.setupPreferencePanel = function () {
        var _this = this;
     ...
     */
    Newton.prototype.placeOnElement = function (element, target, surface, position, center) {
    ...
    */
    Newton.prototype.slideOnElement = function (element, target, duration, delay, surface, position, toScale, center) {
        if (delay === void 0) { delay = 0; }
     ...
     */
    Newton.prototype.slideElementAnim = function (element, target, options) {
        var _this = this;
    ...
    /// -- GAME STATES -- ///
    //#region
    Newton.prototype.onEnteringState = function (stateName, args) {
    ...
    Newton.prototype.onLeavingState = function (stateName) {
    ...
    Newton.prototype.onUpdateActionButtons = function (stateName, args) {
    ...
    /// -- NOTIFICATIONS -- ///
    // #region
    Newton.prototype.setupNotifications = function () {
        var _this = this;
    ...
    Newton.prototype.notif_log = function (notif) {
        console.log('LOGGING!');
        console.log(notif.log);
    };
    Newton.prototype.notif_dump = function (notif) {
        console.log('DUMPING!');
